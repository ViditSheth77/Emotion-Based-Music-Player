...
def recognize_emotion():
    ...
    if pred == 0:
        tune = mp.newMedia("C:/Users/dell/Desktop/Emotion-based-music-player1/Emotion-based-music-player-master/Music/angry/Jee Karda.mp3")
        print("Angry song is playing.")
    elif pred == 1:
        tune = mp.newMedia("C:/Users/dell/Desktop/Emotion-based-music-player1/Emotion-based-music-player-master/Music/happy/Ilahi.mp3")
        print("Happy song is playing.")
    elif pred == 2:
        tune = mp.newMedia("C:/Users/dell/Desktop/Emotion-based-music-player1/Emotion-based-music-player-master/Music/sad/Channa Mereya.mp3")
        print("Sad song is playing.")
    elif pred == 3:
        tune = mp.newMedia("C:/Users/dell/Desktop/Emotion-based-music-player1/Emotion-based-music-player-master/Music/nuetral/Udd Gaye.mp3")
        print("Nuetral song is playing.")
    elif pred == 4:
        tune = mp.newMedia("C:/Users/dell/Desktop/Emotion-based-music-player1/Emotion-based-music-player-master/Music/surprise/DaddyMummy.mp3")
